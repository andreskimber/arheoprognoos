...
```{r select_tools, echo=F, fig.show='hold', fig.align='center', out.width= "80%", fig.cap="Select tööriistad"}
...
- Verstakaart - legende näeb [Maa-ameti ajalooliste kaartide lehelt](https://geoportaal.maaamet.ee/est/Kaardirakendused/Ajaloolised-kaardid/Ajalooliste-kaartide-rakenduse-kirjeldus-p157.html)
